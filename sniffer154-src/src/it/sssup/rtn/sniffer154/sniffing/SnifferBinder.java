...
public class SnifferBinder extends Binder {
	...
	private final ISnifferService mSnifferService;
	
	public SnifferBinder(ISnifferService snifferService) {
		mSnifferService = snifferService;
	}
	
	public ISnifferService getService() {
		return mSnifferService;
	}
